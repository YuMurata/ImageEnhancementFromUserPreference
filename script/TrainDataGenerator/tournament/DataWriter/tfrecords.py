...
from TrainDataGenerator.config.tfrecords import IMAGE_WIDTH, IMAGE_HEIGHT, SUFFIX
...
class WriteThread(Thread):
    ...
    def run(self):
        ...
        resized_image_size = (IMAGE_WIDTH, IMAGE_HEIGHT)
        for i in range(scored_player_length):
            self.scored_player_list[i]['player'] = \
                self.scored_player_list[i]['player'].resize(resized_image_size)
