...
from UserPreferencePredictor.TrainDataMaker.Tournament import Player
import typing
...
class WriteThread(Thread):
    def __init__(self, scored_player_list: typing.List[Player], save_file_path: str, resized_image_size: typing.Tuple[int, int]):
...
class TFRecordsWriter(DataWriter):
    def __init__(self, save_file_path: str, resized_image_size: typing.Tuple[int, int]):
    ...
    def write(self, scored_player_list: typing.List[Player]):
